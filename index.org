...
1.Les entiers doivent être parcourus deux fois :
a. Pour calculer la moyenne.
b. Pour comparer chaque entier à cette moyenne.

2.Il faut enregistrer chaque entier
a. Il faut 20 variables.
b. Il n’est pas possible de faire une boucle qui répète la même opération sur des variables différentes.
...
Lors de la lecture ou de l’assignation d’une case si l’indice est hors des limites du tableau le
programme est en erreur.
